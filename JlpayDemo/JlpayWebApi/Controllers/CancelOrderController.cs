...
namespace JlpayWebApi.Controllers
{
    ...
    {
        [HttpPost]
        public HttpResponseMessage CancelOrderRequest([FromBody] RequestData obj)
        {
            SortedDictionary<string, string> requestInfo = new SortedDictionary<string, string> {
                { "service", "pay.qrcode.cancel" },
                { "mch_id", "84931015812A00N" },
                { "org_code", "50264239" },
                { "nonce_str", "123456789" },
                { "pay_type", "wxpay" },
                { "out_trade_no", "20190415210736801" },
                { "ori_out_trade_no", "20190415210736800" },
                { "total_fee", "100" },
