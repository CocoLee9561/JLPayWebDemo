...
namespace JlpayWebApi.Uitily
{
    ...
    public class HttpHelper
    {
        ...
        {
            string requestParamsJson = JsonUility.SerializeDictionaryToJsonString<string, string>(requestParams);            
            string signData = Signature(requestParamsJson);
            requestParams.Add("sign", signData);

            string reqJson = JsonUility.SerializeDictionaryToJsonString(requestParams);
            return reqJson;
        }
        ...
        {
            Dictionary<string, string> responseDataDic = JsonUility.DeserializeStringToDictionary<string, string>(responseData);
            ...
            string signContent = JsonUility.SerializeDictionaryToJsonString<string, string>(sortedResponseDataDic);
