...
namespace JLPayWebApp.Models
{
    public class MicroPayRequest
    {
        ...
        /// 机构号
        /// </summary>
        [ParamInfo("org_code", "text", "机构号", Required = true, stringLength = 20)]
        public string org_code { get; set; }

        /// <summary>
        /// 商户号
        /// </summary>
        [ParamInfo("mch_id", "text", "商户号", Required = true, stringLength = 15)]
        public string mch_id { get; set; }

        /// <summary>
        /// 终端号
        /// </summary>
        [ParamInfo("term_no", "text", "终端号", stringLength = 8)]
        public string term_no { get; set; }

        /// <summary>
        /// 随机字符串
        /// </summary>
        [ParamInfo("nonce_str", "text", "随机字符串", Required = true, stringLength = 32)]
        ...
        /// 外部订单号
        /// </summary>
        [ParamInfo("out_trade_no", "text", "外部订单号", Required = true, stringLength = 32)]
        public string out_trade_no { get; set; }

        /// <summary>
        /// 商品标题
        /// </summary>
        [ParamInfo("body", "text", "商品标题", Required = true, stringLength = 32)]
        public string body { get; set; }

        /// <summary>
        /// 商品描述
        /// </summary>
        [ParamInfo("attach", "text", "商品描述", Required = true, stringLength = 500)]
        public string attach { get; set; }

        /// <summary>
        /// 交易金额,单位为分
        /// </summary>
        [ParamInfo("total_fee", "text", "交易金额", Required = true, stringLength = 15)]
        public string total_fee { get; set; }

        /// <summary>
        /// 交易类型
        /// </summary>
        [ParamInfo("pay_type", "text", "交易类型", Required = true, stringLength = 10)]
        public string pay_type { get; set; }

        /// <summary>
        /// 终端IP
        /// </summary>
        [ParamInfo("mch_create_ip", "text", "终端IP", Required = true, stringLength = 15)]
        public string mch_create_ip { get; set; }

        /// <summary>
        /// 回调地址
        /// </summary>
        [ParamInfo("notify_url", "text", "回调地址", Required = true, stringLength = 32)]
        ...
        /// 订单有效期
        /// </summary>
        [ParamInfo("payment_valid_time", "text", "订单有效期", stringLength = 4)]
        public string payment_valid_time { get; set; }

        [ParamInfo("auth_code", "text", "授权码", Required = true)]
